...
And answer the following questions about them:
  ...
  * These repositories are at two different websites - github and bitbucket - what are these sites?  What service do they provide? Which is better?
      * these are site of cloud storage for people to use, provide stroge which allow people can upload or download their work anythere with internet connect to their computer
      * personal, I think the bitbucket which better use tells the date of last update
  ...
  * 🤔 Which file in each project has had the most activity?
      * both are active at moment, both project are edit during the months  
      * repository A most file are activity are the data files, repository B most activity file are 
